...
**
** Created: Sat Mar 8 19:43:16 2014
...
public:
    ...
    StashcoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *stashcoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new StashcoinAmountField(tabMain);
        ...
        stashcoinAtStartup = new QCheckBox(tabMain);
        stashcoinAtStartup->setObjectName(QString::fromUtf8("stashcoinAtStartup"));

        verticalLayout_Main->addWidget(stashcoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        stashcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Stashcoin after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        stashcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Stashcoin on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
